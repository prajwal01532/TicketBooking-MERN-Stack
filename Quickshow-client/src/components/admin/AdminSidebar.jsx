...
const AdminSidebar = () => {
  ...
  return (
    <div className="h-[calc(100vh-64px)] md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-gray-300 text-sm">
      <img
        className="h-14 w-9 md:w-14 rounded-full mx-auto"
        src={user.imageUrl}
        alt="sidebar"
      />
          ...
          >
            {({ isActive }) => (
              <>
                ...
                <span
                  className={`w-1.5 h-16 rounded-l right-0 absolute ${
                    isActive && 'bg-primary'
                  }`}
                />
              </>
